  ...
  data() {
      return {
        options:
        {
            ...
            militaryTime: false,
            menuOptions: [{ title: 'Today', values: [moment(), moment()] }]
        }
      }
  },
  methods: {
...
<style>
:root {
  /* Sundown Color Theme Swatches in Hex */
  /* --Accent: #FCBB6D;
--Background: #D8737F;
--Secondary: #AB6C8C;
--Primary: #685D79;
--Shadow: #475C7A; */
  ...
  /* Army Color Theme Swatches in Hex */
  --Accent: #000000;
  --Secondary: #fdd42e;
  --Background: #c0b6a5;
  --Primary: #918b7e;
  ...
  /* PEC Color Theme Swatches in Hex */
  /* --Secondary: #999999;
--Shadow: #B9BBBD;
--Accent: #196DAB;
--Primary: #FAFCFF;
--Background: #E6E8EB; */
  ...
  /* ARMPEC Color Theme Swatches in Hex */
  /* --Shadow: #0F3F61;
--Primary: #196DAB;
--Secondary: #C0B6A5;
--Background: #E6E8EB;
...
.grid-container > .monthHeader > .rightArrow {
  vertical-align: middle;
  grid-column-start: 7;
  grid-column-end: 8;
  height: 48px;
